...
type RegisterRequest struct {
	...
	Roles    []string `protobuf:"bytes,4,rep,name=roles,proto3" json:"roles,omitempty"` // Add any additional fields as needed
}
...
type LoginRequest struct {
	...
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Add any additional fields as needed
}
...
type LoginResponse struct {
	...
	Token   string `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"` // Add any additional fields as needed
}
...
type ValidateRequest struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Add any additional fields as needed
}
...
type ValidateResponse struct {
	...
	UserId int64  `protobuf:"varint,3,opt,name=userId,proto3" json:"userId,omitempty"` // Add any additional fields as needed
}
...
type SocialAuthRequest struct {
	...
	AccessToken string `protobuf:"bytes,2,opt,name=accessToken,proto3" json:"accessToken,omitempty"` // Add any additional fields as needed
}
...
func (x *SocialAuthRequest) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
func (x *SocialAuthRequest) GetAccessToken() string {
	if x != nil {
...
func (x *SocialAuthResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *SocialAuthResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ForgotPasswordRequest struct {
	...
	Email string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"` // Add any additional fields as needed
}
...
var file_pkg_auth_pb_auth_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x75,
	...
	0x72, 0x6f, 0x6c, 0x65, 0x73, 0x22, 0x46, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x72, 0x49, 0x64, 0x22, 0x51, 0x0a, 0x11, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x41, 0x75, 0x74,
	0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x76,
	0x69, 0x64, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5e, 0x0a, 0x12, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c,
	...
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x4c, 0x0a, 0x16, 0x46, 0x6f, 0x72, 0x67, 0x6f, 0x74, 0x50,
	...
	0x61, 0x67, 0x65, 0x32, 0xcd, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	...
	0x00, 0x12, 0x41, 0x0a, 0x0a, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x12,
	0x17, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x41, 0x75, 0x74,
	0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x53, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x0e, 0x46, 0x6f, 0x72, 0x67, 0x6f, 0x74, 0x50, 0x61,
	...
	0x65, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x75, 0x74,
...
var file_pkg_auth_pb_auth_proto_goTypes = []interface{}{
	...
	(*SocialAuthRequest)(nil),      // 6: auth.SocialAuthRequest
	(*SocialAuthResponse)(nil),     // 7: auth.SocialAuthResponse
...
var file_pkg_auth_pb_auth_proto_depIdxs = []int32{
	...
	6, // 3: auth.AuthService.SocialAuth:input_type -> auth.SocialAuthRequest
	...
	7, // 8: auth.AuthService.SocialAuth:output_type -> auth.SocialAuthResponse
...
func file_pkg_auth_pb_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_auth_pb_auth_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SocialAuthRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_auth_pb_auth_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SocialAuthResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
